...
export function RenewalCreateForm({
  ...
  return (
    <form ref={formRef} onSubmit={handleSubmit} className={formSectionCard}>
      <div className="mb-4">
    ...
    <div className="lg:col-span-4 rounded-[24px] bg-emerald-50/70 p-4">
      ...
      <div className="grid grid-cols-1 gap-3 lg:grid-cols-4">
        <label className={formFieldLabel + " lg:col-span-2"}>
          <span className={formLabelText}>銃の管理名</span>
          <input
            name="firearmDisplayName"
            placeholder="例: 山用ライフル"
            className={`min-h-12 w-full min-w-0 rounded-[18px] px-4 ${errors.firearmDisplayName ? "border-red-500" : "border-slate-200"} bg-slate-50`}
          />
          <FieldError error={errors.firearmDisplayName} />
        </label>

        <label className={formFieldLabel}>
          <span className={formLabelText}>銃種</span>
          <select
            name="firearmType"
            defaultValue="SHOTGUN"
            className={`min-h-12 w-full rounded-[18px] px-4 ${errors.firearmType ? "border-red-500" : "border-slate-200"} bg-slate-50`}
          >
        ...
        <label className={formFieldLabel}>
          <span className={formLabelText}>状態</span>
          <select
            name="firearmStatus"
            defaultValue="ACTIVE"
            className={`min-h-12 w-full rounded-[18px] px-4 ${errors.firearmStatus ? "border-red-500" : "border-slate-200"} bg-slate-50`}
          >
        ...
        <label className={formFieldLabel}>
          <span className={formLabelText}>メーカー</span>
          <input
            name="manufacturer"
            placeholder="例: Browning"
            className={`min-h-12 w-full min-w-0 rounded-[18px] px-4 ${errors.manufacturer ? "border-red-500" : "border-slate-200"} bg-slate-50`}
          />
          <FieldError error={errors.manufacturer} />
        </label>

        <label className={formFieldLabel}>
          <span className={formLabelText}>型式</span>
          <input
            name="modelName"
            placeholder="例: A5"
            className={`min-h-12 w-full min-w-0 rounded-[18px] px-4 ${errors.modelName ? "border-red-500" : "border-slate-200"} bg-slate-50`}
          />
        ...
        <label className={formFieldLabel}>
          ...
          <input
            name="caliber"
            placeholder="例: 12番"
            className={`min-h-12 w-full min-w-0 rounded-[18px] px-4 ${errors.caliber ? "border-red-500" : "border-slate-200"} bg-slate-50`}
          />
          <FieldError error={errors.caliber} />
        </label>

        <label className={formFieldLabel}>
          <span className={formLabelText}>銃の全長</span>
          <input
            name="firearmTotalLength"
            placeholder="例: 110.0cm"
            className={`min-h-12 w-full min-w-0 rounded-[18px] px-4 ${errors.firearmTotalLength ? "border-red-500" : "border-slate-200"} bg-slate-50`}
          />
        ...
        <label className={formFieldLabel}>
          ...
          <input
            ...
            className={`min-h-12 w-full min-w-0 rounded-[18px] px-4 ${errors.firearmBarrelLength ? "border-red-500" : "border-slate-200"} bg-slate-50`}
          />
        ...
        <label className={formFieldLabel}>
          ...
          <input
            ...
            className={`min-h-12 w-full min-w-0 rounded-[18px] px-4 ${errors.firearmRiflingRate ? "border-red-500" : "border-slate-200"} bg-slate-50`}
          />
          <FieldError error={errors.firearmRiflingRate} />
        </label>

        <label className={formFieldLabel}>
          <span className={formLabelText}>弾倉形式及び充填可能弾数</span>
          <input
            name="firearmMagazineSpec"
            placeholder="例: チューブ型 2発"
            className={`min-h-12 w-full min-w-0 rounded-[18px] px-4 ${errors.firearmMagazineSpec ? "border-red-500" : "border-slate-200"} bg-slate-50`}
          />
        ...
        <label className={formFieldLabel}>
          ...
          <input
            ...
            placeholder="例: 12番"
            className={`min-h-12 w-full min-w-0 rounded-[18px] px-4 ${errors.firearmCompatibleAmmo ? "border-red-500" : "border-slate-200"} bg-slate-50`}
          />
        ...
        <label className={formFieldLabel}>
          ...
          <input
            ...
            className={`min-h-12 w-full min-w-0 rounded-[18px] px-4 ${errors.firearmFeatures ? "border-red-500" : "border-slate-200"} bg-slate-50`}
          />
          <FieldError error={errors.firearmFeatures} />
        </label>

        <label className={formFieldLabel}>
          <span className={formLabelText}>用途</span>
          <input
            name="firearmPurposeText"
            placeholder="例: 狩猟"
            className={`min-h-12 w-full min-w-0 rounded-[18px] px-4 ${errors.firearmPurposeText ? "border-red-500" : "border-slate-200"} bg-slate-50`}
          />
          <FieldError error={errors.firearmPurposeText} />
        </label>

        <label className={formFieldLabel}>
          <span className={formLabelText}>銃番号</span>
          <input
            name="serialNumber"
            placeholder="銃番号を入力すると登録"
            className={`min-h-12 w-full min-w-0 rounded-[18px] px-4 ${errors.serialNumber ? "border-red-500" : "border-slate-200"} bg-slate-50`}
          />
        ...
        <label className={formFieldLabel}>
          ...
          <DateInput
            ...
            className={`${formFieldCompact} ${errors.firearmPermittedOn ? "border-red-500" : ""}`}
          />
        ...
        <label className={formFieldLabel}>
          ...
          <DateInput
            ...
            className={`${formFieldCompact} ${errors.firearmExpiresOn ? "border-red-500" : ""}`}
          />
        ...
        <label className={formFieldLabel + " lg:col-span-4"}>
          ...
          <textarea
            ...
            className={`${formTextareaCompact} ${errors.firearmNotes ? "border-red-500" : ""}`}
          />
